    ...
    <div class="main-page-blog">
        <div class="container">
            <div class="blog-content">
                ...
                <p>תוכלו לבצע פעולות בממשק החדש (להעלות מוצרים וכו’)&nbsp;– רק זכרו כל שינוי שתבצעו יבוא לידי ביטוי בחנות כשנעלה לאוויר.</p>
                ...
                <ol>
                    <li>
                        <h4><strong>הגדרות חנות.</strong>&nbsp;להיכנס להגדרות החנות ולוודא שכל הפרטים שלכם מעודכנים כמו שצריך (מדיניות החנות, מדיניות משלוחים, כתובת החנות וכו’)</h4>
                    </li>
                </ol>
                <ol>
                    <li value="2">
                        <h4><strong>סליקה</strong>. לבדוק שיש לכם ספק סליקה פעיל. זאת תוכלו לבדוק בטאב – “הגדרות חנות סליקה” – שנמצא מצד שמאל למעלה.</h4>
                    </li>
                </ol>
                <ol>
                    <li value="3">
                        <h4><strong>משלוחים</strong>. שדרגנו את מנגנון המשלוחים וכעת במקום להגדיר שיטת משלוח לכל מוצר – עליכם להגדיר ראשית את הסכום הקבוע עבור כל שיטת משלוח. אחר כך תגדירו לכל מוצר איזה שיטת משלוח אפשרית לו.</h4>
                        <p>4. והכי חשוב – יש בממשק הדרכה אונליין. כדי להגיע אליה צריך ללחוץ על כפתור HELP מצמד ימין למטה. שם תבחרו את ההדרכה הנחוצה לכם מתוך התהליכים המרכזיים בניהול החנות.</p>
                    </li>
                </ol>
            </div>
